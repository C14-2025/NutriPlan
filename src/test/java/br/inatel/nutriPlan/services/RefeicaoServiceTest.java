...
public class RefeicaoServiceTest {
  ...
  @InjectMocks private RefeicaoService refeicaoService; // indicando onde o mock deve ser injetado
  ...
  public void testDelete() {
    ...
    verify(refeicaoRepository, times(1))
        .delete(refeicaoSaved); // verificando se delete foi chamado uma vez
  }

...
class AlimentoControllerTest {
  @Mock private AlimentoService service; // aqui eu estou mockando o comportamento do service

  @InjectMocks private AlimentoController controller; // e injetando no controller
